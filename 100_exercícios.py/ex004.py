...
print ('O tipo primitivo dos dados digitados é', type(n1))
...
print ('Os dados digitados foram escritos como um titulo?', n1.istitle()) # O Pequeno Príncipe_observe as letras maiusculas;
print ('Os dados digitados podem ser usados para impressão?', n1.isprintable())